...
const translations: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    bookingCreatedMsg: 'Бронь {date} · {s}–{e} · {dur} создана и ожидает подтверждения.',
  ...
  kk: {
    ...
    bookingCreatedMsg: '{date} · {s}–{e} · {dur} — бронь жасалды және растауды күтуде.',
    ...
    appealRating: 'Бағаға шағымдану',
    appealTitle: 'Бағаға шағымдану',
    appealReason: 'Шағымдану себебі',
    ...
    clearHistory: 'Тарихты тазалау керек пе?',
